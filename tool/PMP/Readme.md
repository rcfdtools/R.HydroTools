...
Spanish title: Estudio y análisis de la Precipitación Máxima Probable (PMP) en la red de estaciones automáticas de Colombia - Suramérica y estimación de valores extremos para diferentes periodos de retorno a partir de múltiples distribuciones de probabilidad.

English title: Study and analysis of the Probable Maximum Precipitation (PMP) in the network of automatic stations in Colombia - South America and estimation of extreme values for different return periods from Multiple probability distributions.
