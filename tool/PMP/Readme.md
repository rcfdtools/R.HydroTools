...
Paper: [rcfdtools digital](https://github.com/rcfdtools/R.HydroTools/blob/main/tool/PMP/dataset/pmax24h_out/paper/Readme.md), Rearchgate, DOI, Dialnet
...
| [JDRA](https://github.com/uescuelaing/J.HRAS)                                   | • Main abstract.<br/>• General conclusions.<br/>• Detailed resoults validation.<br/>• Spanish paper translation.<br/>• Paper file document (.docx, pdf).<br/>• Global references (Mendeley).<br/>• Publishing in an indexed engineer magazine. |
