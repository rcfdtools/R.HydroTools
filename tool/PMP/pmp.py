...
for station in stations:
    ...
    funcs.print_log(file_log, f'\n\n:file_folder:File: [dataset.csv](../../{station_dataset_file})', on_screen = print_on_screen)
    ...
    for emp in edf_dist:
        ...
        if create_plot & plot_only_simple == False: funcs.print_log(file_log, f'<img alt="R.HydroTools" src="{fig_file1}" width="1200"></img>', center_div=True, on_screen = print_on_screen)
        funcs.print_log(file_log, f'\n**{num_inc}.3. Best fit**\n', on_screen = print_on_screen)
    ...
    funcs.print_log(file_log, f'\n\n:file_folder:File: [extreme_{station_code}.csv](table/extreme_{station_code}.csv), all PDFs.  \n:file_folder:File: [extremediff_{station_code}.csv](table/extremediff_{station_code}.csv), % difference between bestfit and most used PDFs in Hydrology.\n', on_screen = print_on_screen)
