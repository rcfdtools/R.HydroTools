...
for station in stations:
    ...
    funcs.print_log(file_log, f'\n\n:file_folder:Tables:\n* [extreme_{station_code}.csv](table/extreme_{station_code}.csv) (all PDFs)\n* [extremediff_{station_code}.csv](table/extremediff_{station_code}.csv) (% difference between bestfit and most used PDFs in Hydrology)\n', on_screen = print_on_screen)
