...
dicts = {
    ...
    'station_record': 'Number of records (yearly values) founded per station for the probability distributions analysis. The current study, consider as valid any station with at least 10 years of records which are necessary to obtain stable storm or flow properties.',
