...
x_label = 'Value'  # Initial value column name to eval from .csv station file
date_label = 'Date'  # Initial value column name from .csv station file
...
station_file = input_path + '25020280_1969_2009.csv'
