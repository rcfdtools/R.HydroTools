...
* Fecha y hora de inicio de ejecución: 2021-12-29 11:52:49.592293
...
* Analizar solo drenajes permanentes: True
...
Grafica Área, km² vs. # Drenajes - Solo drenajes subtipo permanente

![Graph0](https://github.com/rcfdtools/R.GISPython/blob/main/HydroGeoZone//Graph/PlotAreaVsFREQUENCYDrainPer.png)

Grafica Área, km² vs. Sum. Long. Drenajes, km - Solo drenajes subtipo permanente

![Graph1](https://github.com/rcfdtools/R.GISPython/blob/main/HydroGeoZone//Graph/PlotAreaVsSUM_LDreDrainPer.png)

Grafica Área, km² vs. Kc - Índice de Compacidad - Solo drenajes subtipo permanente

![Graph2](https://github.com/rcfdtools/R.GISPython/blob/main/HydroGeoZone//Graph/PlotAreaVsKcDrainPer.png)

Grafica Área, km² vs. Dd - Densidad de drenajes - Solo drenajes subtipo permanente

![Graph3](https://github.com/rcfdtools/R.GISPython/blob/main/HydroGeoZone//Graph/PlotAreaVsDdDrainPer.png)

Grafica Área, km² vs. Dc - Densidad de corrientes - Solo drenajes subtipo permanente

![Graph4](https://github.com/rcfdtools/R.GISPython/blob/main/HydroGeoZone//Graph/PlotAreaVsDcDrainPer.png)
...
* Capa Drenajes filtro permanentes: D:/R.GISPython/HydroGeoZone/Output/DrenajeSencilloFiltro.shp
...
Fecha y hora de terminación de ejecución: 2021-12-29 12:03:07.272410

Proceso completado (dt = 617.7 sec o 10.3 min)
